...
bot.start((ctx) => ctx.replyWithHTML(
    ...
    'Для использования просто отправьте боту команду <code>/search</code> с перечислением ключевых слов через пробел, <b>без знаков препинания и спец-символов</b>. Например: <code>/search удаленные</code> или <code>/search мобильная</code>.'
));
